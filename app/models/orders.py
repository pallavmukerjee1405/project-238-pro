...
class Orders(db.Model):#A class for storing all order details
    ...
    @staticmethod
    def create(user_id, product_id, quantity, address_id, amount):#To generate new order details
        order_dict = dict(
            guid = str(uuid.uuid4()),
            user_id = user_id,
        ...
        #Below code to push order details into class Orders
